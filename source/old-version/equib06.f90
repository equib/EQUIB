...
!     !Else Coll. rates = tabulated values * 10 ** IRATS
   ...
   20 IF(IBIG.EQ.1.OR.IBIG.EQ.2) THEN 
      ...
      IND=IND+1 
      OPEN(UNIT=3,STATUS='UNKNOWN',file='equib_pop.dat') 
      OPEN(UNIT=4,STATUS='UNKNOWN',file='equib_rat.dat') 
      OPEN(UNIT=7,STATUS='UNKNOWN',file='equib_pop.lis') 
      OPEN(UNIT=8,STATUS='UNKNOWN',file='equib_rat.lis')
